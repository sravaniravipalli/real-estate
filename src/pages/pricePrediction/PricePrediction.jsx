      ...
      <div className="mt-12 modern-card p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-gray-700">Our prediction uses a trained Random Forest machine learning model that analyzes multiple property features to estimate market value.</p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2">📊 Data Features</h3>
            <p className="text-gray-700">The model considers bedrooms, bathrooms, living area, property condition, and nearby schools to make accurate predictions.</p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2">⚡ Instant Results</h3>
            <p className="text-gray-700">Get estimated property prices in seconds. Perfect for quick valuations and market research.</p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2">✅ Accurate Estimates</h3>
            <p className="text-gray-700">Based on real property data, our model provides reliable price estimates for residential properties.</p>
          </div>
        </div>
      </div>
    </div>
